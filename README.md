...
```bash
wget -O vless-server.sh https://raw.githubusercontent.com/agczsz/vless-all-in-one/refs/heads/main/vless-server.sh && chmod +x vless-server.sh && ./vless-server.sh
```
